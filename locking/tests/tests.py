...
class AppTestCase(TestCase):
    ...
    def test_lock_seconds_remaining(self):
        ...
        self.assertTrue(
            ...
            and self.story.lock_seconds_remaining >= expected - 1,
            "%d not close to %d" % (self.story.lock_seconds_remaining, expected),
        )
    ...
    def test_unlocked_manager(self):
        ...
        self.assertRaises(
            testmodels.Story.DoesNotExist,
            testmodels.Story.unlocked.get,
            pk=self.story.pk,
        )
    ...
    def test_locked_manager(self):
        ...
        self.assertRaises(
            testmodels.Story.DoesNotExist,
            testmodels.Story.locked.get,
            pk=self.alt_story.pk,
        )
